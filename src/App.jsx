    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .spot-card:hover { transform: translateY(-2px); transition: transform 0.2s; }
        .shimmer { background: linear-gradient(90deg, #1E293B 25%, #273549 50%, #1E293B 75%); background-size: 200% 100%; animation: shimmer 1.5s infinite; }
        ...
        .pipe-node::before { content:''; position:absolute; left:19px; top:-16px; width:2px; height:16px; background: linear-gradient(#334155, #475569); }
